  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 data-aos="fade-up" data-aos-duration="1000" className="md:text-2xl font-bold uppercase">about me 🤔</h1>
          <p data-aos="fade-up" data-aos-duration="1500" className="md:text-base">
